...
function A() {
  ...
  const { requestType: t, body: e, options: n } = g[0][0];
  !(function (t, e, n, o) {
    const { extraRequestOnError: i } = W,
      a = k(t);
    let u;
    t !== l && (u = e || {});
    const c = t === l ? "GET" : "POST",
      d = n.info || {},
      f = { requestType: t, endpoint: a, requestBody: u, info: d },
      h = [],
      p = [],
      m = new CustomEvent(y, {
        detail: {
    ...
    const b = new CustomEvent(v, {
      detail: {
        requestState: { requestType: t, endpoint: a, info: d, requestBody: u },
      },
    });
    if ((document.dispatchEvent(b), d.cancel))
      return (f.responseData = null), void L(n, o, f);
    if (void 0 !== u) {
      let e;
      if (
        ...
        if (
          (Array.isArray(e) ? h.push(...e) : h.push(...e.split(",")),
          s === t && p.push(...h.slice(0, 5)),
          h.length > 5)
        ) {
          p.push(...h.slice(5));
    ...
    t !== l &&
      (u instanceof FormData || u instanceof URLSearchParams
        ? ((q.body = u), (q.headers = { "x-requested-with": "XMLHttpRequest" }))
        : ((q.body = JSON.stringify(u)),
      ...
      fetch(a, q)
        ...
        .then((t) =>
          r(this, void 0, void 0, function* () {
            return (
              (f.responseData = t),
              !f.responseData.ok && i && p.unshift(...h.slice(0, 5)),
              p.length > 0 && (f.extraResponseData = yield j(p)),
              f
            );
          })
        )
...
function L(t, e, n) {
  ...
  const r = new CustomEvent(q, { detail: o });
...
function Z(t) {
  const e = t.shift();
  if (e) {
    if (e.type && [s, a, u, c, l].includes(e.type))
      return void w({
        requestType: e.type,
        body: e.body,
        options: {
...
function vt(t) {
  return !(
    ...
    (!(
      ...
      (console.error(
        `Liquid Ajax Cart: the ${yt} attribute supports "input" elements of types "text", "number" and non-multiple "select" elements`
      ),
      1))
  );
}
...
function qt(t, e) {
  ...
  if (isNaN(n))
    return void console.error(
      `Liquid Ajax Cart: input value of a ${yt} must be an Integer number`
    );
  if ((n < 1 && (n = 0), !o))
    return void console.error(
      `Liquid Ajax Cart: attribute value of a ${yt} must be an item key or an item index`
    );
...
function $t(t) {
  ...
  console.error(
    `Liquid Ajax Cart: the element [${gt}="${e}"]${
      n ? `[name="${n}"]` : ""
  ...
  document.querySelectorAll(`[${gt}]`).forEach((t) => {
    ...
    if ("note" === e) r = i.cart.note;
      ...
      t && (r = t.properties[n]),
        null === t &&
          (console.error(
            `Liquid Ajax Cart: line item with ${a}="${e}" was not found when the [${gt}] element with "${o}" value tried to get updated from the State`
          ),
          (s = !0));
    }
    ...
    ("checkbox" === t.type || "radio" === t.type)
      ...
      : ("string" == typeof r ||
          ...
          (Array.isArray(r) || r instanceof Object
            ? ((r = JSON.stringify(r)),
              console.warn(
                `Liquid Ajax Cart: the ${gt} with the "${o}" value is bound to the ${n} ${
...
function Lt(t, e) {
  ...
  if (t instanceof HTMLInputElement && "checkbox" === t.type && !t.checked) {
    ...
    t ||
      ("note" !== o && "attributes" !== o) ||
      (t = document.querySelector(`input[type="hidden"][${gt}][name="${r}"]`)),
      (s = t ? t.value : "");
  }
  if ("note" === o) {
    const e = new FormData();
    e.set("note", s), T(e, { info: { initiator: t } });
  } else if ("attributes" === o) {
    const e = new FormData();
    e.set(`attributes[${i}]`, s), T(e, { info: { initiator: t } });
  } else {
    const [e, a] = mt(o, n);
    if (
      (null === e &&
        console.error(
          `Liquid Ajax Cart: line item with ${a}="${o}" was not found when the [${gt}] element with "${r}" value tried to update the cart`
        ),
      !e)
    )
      return;
    ...
    for (let t in u) {
      ...
      "string" == typeof n || n instanceof String
        ...
        : (l = { [a]: o, quantity: e.quantity, properties: u });
    }
    ...
    customElements.define(
      ...
      class extends HTMLElement {
        ...
        connectedCallback() {
          ...
          1 === t.length
            ? ((this._$input = t[0]),
              this._$input.hasAttribute(yt)
                ? ((this._$buttons = Array.from(
                    this.querySelectorAll(`[${xt}], [${St}]`)
                  )),
                  ...
                  this._$buttons.forEach((t) => {
                    t.addEventListener("click", (e) => {
                      ...
                      if (!_()) {
                        ...
                        if (isNaN(e))
                          return void console.error(
                            `Liquid Ajax Cart: "${jt}" element's input value isn't a number`,
                            this._$input,
                            this
                          );
                        let n = e;
                ...
                : console.error(
                    `Liquid Ajax Cart: "${jt}" element's input must have the "${yt}" attribute`,
                    this._$input,
                    this
                  ))
            : console.error(
                `Liquid Ajax Cart: "${jt}" element must have one "input" element as a child, ${t.length} found`,
                this
              );
        }
        _runAwaiting() {
...
function Mt() {
  ...
  t.classList.toggle(kt, null !== e.cart),
    ...
    t.classList.toggle(Rt, e.cart.item_count > 0);
}
let Nt = !1;
  ...
  (window.liquidAjaxCart = {
    ...
    document.addEventListener(b, (t) => {
      ...
      const o = (function (t) {
        ...
        const c =
          ...
          (null ===
            (a =
              null === (s = t.responseData) || void 0 === s
                ? void 0
                : s.body) || void 0 === a
            ? void 0
            : a.message);
    ...
    (function () {
      ...
      document.addEventListener(b, H),
        H(),
        Ct(),
        document.addEventListener(f, Mt),
        document.addEventListener(b, Mt),
        document.addEventListener(p, Mt),
        Mt(),
